...
Framework::Framework(HINSTANCE hInstance, int nCmdShow, int width, int height, const wchar_t* pAppName)
	: m_screenWidth(width), m_screenHeight(height), m_clearColor{0, 0, 0, 1}, m_pAppName(pAppName)
{
	// Register class
	WNDCLASSEX wcex;
